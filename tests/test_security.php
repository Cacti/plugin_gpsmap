...
$icons = array('Green.png' => 'Green.png', 'Red.png' => 'Red.png', 'Orange.png' => 'Orange.png');
...
assert_equal('normalize: array falls back',          'Green.png', gpsmap_normalize_icon_name(array('Red.png'), $icons));
assert_equal('normalize: integer falls back',        'Green.png', gpsmap_normalize_icon_name(1, $icons));
assert_equal('normalize: empty icon set falls back', 'Green.png', gpsmap_normalize_icon_name('Red.png', array()));
